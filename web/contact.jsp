<%-- 
    Document   : contact
    Created on : Feb 23, 2025, 10:04:07 PM
    Author     : admin
--%>
...
<html lang="en" data-x="html" data-x-toggle="html-overflow-hidden">
    ...
    <!-- Mirrored from creativelayers.net/themes/swiss-resort-html/contact.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 20 Feb 2025 12:19:19 GMT -->
    <head>
        <!-- Required meta tags -->
        <meta charset="UTF-8">
        ...
        <main>
            ...
            <section data-anim-wrap class="pageHero -type-1 -items-center">
                <div data-anim-child="img-right cover-white delay-1" class="pageHero__bg">
                    <img src="${pageContext.request.contextPath}/img/pageHero/4.png" alt="image">
                </div>
                        ...
                        <div class="col-auto">
                            <div data-split='lines' data-anim="split-lines delay-3" class="pageHero__content text-center">
                                ...
                                <p class="pageHero__text lh-17 text-white mt-30">
                                    ...
                                    you need to ask? Call us or e-mail us, here are all the
                    ...
                    <div class="row justify-end">
                        <div class="col-md-5">
                            ...
                            <div class="text-white mt-30">
                                ...
                                <br>
                                <div><a href="#">khoaanhbinh@fpt.edu.vn</a></div>
                                <div><a href="#">+84 999 999 99</a></div>
                            </div>
